        ...
        <div class="col-12">
            <div class="card mb-4 mx-4">
                ...
                <div class="card-body px-4 pt-0 pb-2">
                    <form method="POST" action="<?php echo URL_APP . '/categories/update/' . $category['cat_id']; ?>" id="form" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="<?php if (isset($_SESSION['category_name'])) echo 'border border-danger rounded-3'; ?>">
                                    <input class="form-control" type="text" value="<?php echo $category['category_name']; ?>" placeholder="category name" id="category_name" name="category_name" required>
