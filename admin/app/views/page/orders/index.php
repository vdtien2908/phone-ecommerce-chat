                                ...
                                <?php else : ?>
                                    <?php foreach ($orders as $index => $order) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <p class="text-xs text-center font-weight-bold mb-0 text-truncate" style="max-width: 130px;"><?php echo $order['name_receiver']; ?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <p class="text-xs text-center font-weight-bold mb-0 text-truncate" style="max-width: 130px;"><?php echo $order['address_receiver']; ?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <p class="text-xs text-center font-weight-bold mb-0"><?php echo $order['phone_receiver']; ?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <p class="text-xs text-center font-weight-bold mb-0"><?php echo $order['total_price']; ?></p>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <p class="text-xs text-center font-weight-bold mb-0 text-truncate" style="max-width: 130px;"><?php echo $order['notes']; ?></p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <span class="mx-3" data-bs-toggle="modal" data-bs-target="#previewModal<?php echo $order['order_id']; ?>">
                                                    <i class="fas fa-search text-secondary cursor-pointer"></i>
                                                </span>
                                                <span type="button" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $order['order_id']; ?>" class="<?php echo ($order['status'] == 'đã hủy' || $order['status'] == 'đã giao') ? 'disabled-button' : ''; ?>">
                                                    <i class="cursor-pointer fas fa-trash text-secondary"></i>
                                                </span>

                                                <div class="modal fade" id="previewModal<?php echo $order['order_id']; ?>" tabindex="-1" aria-labelledby="previewModal" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="d-flex justify-content-between mt-2">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['order_id'] . $order['created_at']; ?></span>
                                                                    </div>
                                                                    <div class="d-flex align-items-center gap-1">
                                                                ...
                                                                <div class="d-flex justify-content-between">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['created_at']; ?></span>
                                                                    </div>
                                                                </div>
                                                                <hr class="mb-3">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-6 col-sm-12 d-flex flex-column align-items-start">
                                                                        <span class="text-secondary">Tên người nhận<span class="text-danger">*</span>:</span>
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['name_receiver']; ?></span>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-6 col-sm-12 d-flex flex-column align-items-center">
                                                                        <span class="text-secondary">Địa chỉ người nhận<span class="text-danger">*</span>:</span>
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['address_receiver']; ?> </span>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-6 col-sm-12 d-flex flex-column align-items-end text-start">
                                                                        <span class="text-secondary">SĐT người nhận<span class="text-danger">*</span>:</span>
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['phone_receiver']; ?> </span>
                                                                    </div>
                                                                    <div class="col-12 d-flex align-items-center gap-1 mt-2">
                                                                        <span class="text-secondary">Ghi chú<span class="text-danger">*</span>:</span>
                                                                        <span class="text-dark font-weight-bold"><?php echo $order['notes']; ?> </span>
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <table class="table align-items-center mb-0">
                                                                            ...
                                                                            <tbody>
                                                                                <?php foreach ($order['orderDetail'] as $detail) : ?>
                                                                                    <tr>
                                                                                        <td class="ps-4">
                                                                                            <p class="text-xs font-weight-bold mb-0"><?php echo $detail['order_detail_id']; ?></p>
                                                                                        </td>
                                                                                        <td>
                                                                                            <div>
                                                                                                <p class="text-xs font-weight-bold mb-0"><?php echo $detail['product']['product_name']; ?></p>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td class="d-flex justify-content-center">
                                                                                            <img src="<?php echo IMAGES_PATH . '/' . $detail['product']['image']; ?>" alt="Product Image" class="img-responsive avatar avatar-md me-3">
                                                                                        </td>
                                                                                        <td>
                                                                                            <div>
                                                                                                <p class="text-xs font-weight-bold mb-0"><?php echo number_format($detail['product']['price'], 0, '', ','); ?></p>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                            <div>
                                                                                                <p class="text-xs font-weight-bold mb-0"><?php echo $detail['quantity']; ?></p>
                                                                                            </div>
                                                                                        </td>
                                                                                        <td>
                                                                                            <div>
                                                                                                <p class="text-xs font-weight-bold mb-0"><?php echo $detail['product']['categories']['category_name']; ?></p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                <?php endforeach; ?>
                                                            ...
                                                            <div class="modal-footer d-flex justify-content-between">
                                                                <span class="text-secondary fs-5">
                                                                    Tổng tiền: <strong> <?php echo number_format($order['total_price'], 0, '', ','); ?></strong> VNĐ.
                                                                </span>
                                                                <div class="d-flex gap-2">
                                                                    <button type="button" class="btn btn-outline-primary" data-bs-dismiss="modal">Trở về</button>
                                                                    <form method="POST" id="update_form" action="<?php echo URL_APP . '/orders/updateOrder' . '/' . $order['order_id']; ?>">
                                                ...
                                                <!-- Delete Modal -->
                                                <div class="modal fade" id="deleteModal<?php echo $order['order_id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Bạn có chắc chắn muốn hủy đơn hàng: <?php echo $order['order_id'] . '.' . $order['created_at']; ?>?
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Trở về</button>
                                                                <form method="POST" id="delete_form" action="<?php echo URL_APP . '/orders/destroy' . '/' . $order['order_id']; ?>">
