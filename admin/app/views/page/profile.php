                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('fullname')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="<?php echo $user['fullname'] ?>" type="text" placeholder="Name" id="user-name" name="fullname">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('password')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="password" placeholder="12345" id="user-password" name="password">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="radio" <?php echo $user['gender'] == 1 ? 'checked' : '' ?> id="gender_male" name="gender" value="1">
                                    <label for="gender_male">Nam</label><br>
                                    <input type="radio" <?php echo $user['gender'] == 0 ? 'checked' : '' ?> id="gender_female" name="gender" value="0">
