      ...
      <?php endif; ?>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link <?php echo ($currentUrl == $usersManagementUrl ? 'active' : ''); ?>" href="<?php echo $usersManagementUrl; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark <?php echo ($currentUrl == $usersManagementUrl ? 'text-white' : 'text-dark'); ?>" aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link <?php echo ($currentUrl == $categoriesManagementUrl ? 'active' : ''); ?>" href="<?php echo $categoriesManagementUrl; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-stream ps-2 pe-2 text-center text-dark <?php echo ($currentUrl == $categoriesManagementUrl ? 'text-white' : 'text-dark'); ?>" aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link <?php echo ($currentUrl == $customersManagementUrl ? 'active' : ''); ?>" href="<?php echo $customersManagementUrl; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-users ps-2 pe-2 text-center text-dark <?php echo ($currentUrl == $customersManagementUrl ? 'text-white' : 'text-dark'); ?>" aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link <?php echo ($currentUrl == $conversationUrl ? 'active' : ''); ?>" href="<?php echo $conversationUrl; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fas fa-sms ps-2 pe-2 text-center text-dark <?php echo ($currentUrl == $conversationUrl ? 'text-white' : 'text-dark'); ?>" aria-hidden="true"></i>
            </div>
        ...
        <li class="nav-item pb-2">
          <a class="nav-link <?php echo ($currentUrl == $permissionUrl ? 'active' : ''); ?>" href="<?php echo $permissionUrl; ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <i style="font-size: 1rem;" class="fa-solid fa-person-circle-minus ps-2 pe-2 text-center text-dark <?php echo ($currentUrl == $permissionUrl ? 'text-white' : 'text-dark'); ?>" aria-hidden="true"></i>
            </div>
