...
(12, 21, 1, '2024-03-11 09:36:47', '2024-03-11 09:36:47', NULL, NULL, NULL),
...
(3, 'Samsung', 1, '2024-03-09 14:40:45', '2024-03-09 14:40:45', NULL, NULL, NULL),
...
(59, 'Vũ Đức Tiến', 'vuductien@gmail.com', '$2y$10$JfgnCNEh49tb8pR1XVcHu.fhDWXC2jOi5PYYXwfdTzQ1dukt1BwY.', NULL, NULL, NULL, 0, 1, '2024-08-29 03:02:49', '2024-08-29 03:02:49', NULL, NULL, NULL);
...
INSERT INTO `users` (`user_id`, `fullname`, `image`, `email`, `password`, `address`, `phone`, `gender`, `role`, `created_at`, `updated_at`, `created_by`, `updated_by`, `deleted_by`) VALUES
(1, 'Admin', 'users_images/eb8a2d4755e2a40199734c1d150beba0tomas-stanislavsky-9PRQ44avKik-unsplash.jpg', 'admin@admin.com', '$2y$10$ZR5v8ErSmARLbbj51tGMNOCB9pbM4gp5zGMBP6zvedq8Z0qKdYL7G', 'An adminstrator with experience have been trained in difficult enviroment .', '04758275026', 1, 'admin', '2024-03-09 13:59:15', '2024-04-22 07:25:33', NULL, NULL, NULL),
(3, 'Nỡ phạm thị', 'users_images/c78a039f04487c3ce2b9bccec4c2fa8dtomas-stanislavsky-9PRQ44avKik-unsplash.jpg', 'npt@gmail.com', '$2y$10$o0lplGBq7RChpbDZudMIrue19Y4aLTBV9dpmdbt5ne7dUdbq2BcoK', 'Cần Thơ Viêt Nam', '1234567890', 0, 'user', '2024-04-04 05:26:08', '2024-04-22 07:13:39', NULL, NULL, NULL),
(8, 'pham tuan 1', 'users_images/7ef697e3d49b9674e0e891ddb45be240thought-catalog-505eectW54k-unsplash.jpg', 'tuan@gmail.com', '$2y$10$pQhfBQ1qXR7XXgWDCDA98ukLaSBFZu3tdVA.ePnIdkD9ojZ3Yifjm', 'TP Hcm', '0985748573', 1, 'admin', '2024-05-09 09:01:33', '2024-09-16 04:57:59', NULL, 1, NULL);
...
--
ALTER TABLE `cart_details`
  MODIFY `cart_detail_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT for table `categories`
--
ALTER TABLE `categories`
  MODIFY `cat_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT for table `order_details`
--
ALTER TABLE `order_details`
  MODIFY `order_detail_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
