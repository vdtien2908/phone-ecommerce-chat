...
<section class="shop quad">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                <div class="checkout__form__input">
                    ...
                    <input class="form-control" type="text" placeholder="Nguyễn Văn An" value="<?php echo isset($_SESSION['auth']['customer_name']) ? $_SESSION['auth']['customer_name'] : "" ?>" name="customer_name" required>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                <div class="checkout__form__input">
                    <span>Email<span class="text-danger">*</span></span>
                    <input class="form-control" type="text" placeholder="abc@gmail.com" value="<?php echo isset($_SESSION['auth']['email']) ? $_SESSION['auth']['email'] : "" ?>" name="email" required>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                <div class="checkout__form__input">
                    <span>Số điện thoại<span class="text-danger">*</span></span>
                    <input class="form-control" type="number" placeholder="+84" value="<?php echo isset($_SESSION['auth']['phone']) ? $_SESSION['auth']['phone'] : "" ?>" name="phone" required>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 mb-3">
                <div class="checkout__form__input">
                    <span>Ngày sinh<span class="text-danger">*</span></span>
                    <input class="form-control" type="date" id="birthday" value="<?php echo isset($_SESSION['auth']['birthday']) ? $_SESSION['auth']['birthday'] : "" ?>" name="birthday" required>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="checkout__form__input">
                    <span>Địa chỉ <span class="text-danger">*</span></span>
                    <input class="form-control" type="text" placeholder="Tên đường, phường, xã" value="<?php echo isset($_SESSION['auth']['address']) ? $_SESSION['auth']['address'] : "" ?>" name="address" required>
                </div>
            </div>
        </div>
        ...
        <span class="text-dark mt-3 d-flex justify-content-end">
            Bạn muốn đổi mật khẩu mới? <a href="<?php echo URL_APP . '/auth/forgotPassword' ?>" class="text-primary ml-2"> Thay đổi mật khẩu.</a>
        </span>
    </div>
</section>
