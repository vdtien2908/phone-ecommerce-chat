<section class="min-vh-100 mb-5 pb-5">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url('<?php echo SCRIPT_ROOT . '/assets/img/curved14.jpg' ?>');">
        ...
        <div class="row mt-3">
            <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                <div class="card z-index-0">
                    <div class="card-header rounded-sm bg-white text-center pt-4">
                        <h4 class="text-dark font-weight-bold">Đăng ký tài khoản sau vài bước đơn giản</h4>
                    </div>
                    <!-- <div class="row px-3">
                        <div class="col-3 ml-auto px-1">
                        ...
                        <br>
                        <div class="col-12 mt-2 position-relative text-center">
                    ...
                    <div class="card-body contact__form">
                        <form role="form text-left" class="form" id="form" method="POST" action="http://localhost/phone-ecommerce-chat/customer/auth/signUp">
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="Họ và tên" name="customer_name" id="customer_name" aria-label="customer_name" aria-describedby="customer_name" value="<?php echo isset($_SESSION['old']['customer_name']) ? htmlspecialchars($_SESSION['old']['customer_name']) : ''; ?>" required>
                            </div>
                            <div class="mb-3">
                                <input type="email" class="form-control" placeholder="Email" name="email" id="email" aria-label="Email" aria-describedby="email-addon" value="<?php echo isset($_SESSION['old']['email']) ? htmlspecialchars($_SESSION['old']['email']) : ''; ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="form-check form-check-info text-left mb-5">
                                <input class="form-check-input" type="checkbox" name="agreement" id="flexCheckDefault" style="width: 15px; height: 15px;" checked>
                                <label class="form-check-label" for="flexCheckDefault">
                                    Đồng ý với các điều khoản
                                </label>
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn btn-dark w-100 mt-4">Đăng ký</button>
                            </div>
